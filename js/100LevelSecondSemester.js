...
for (let i = 0; i < courseCode.length; i++) {
    courseCode[i].addEventListener("click", event => {
        if (event.target.checked) {
            if (courseCode[i].value === "csc102") {
                courseUnit = 2
                grade[i].style.display = "block"
            }
            else if(courseCode[i].value === "chm102"){
                courseUnit = 4
                grade[i].style.display ="block"
            }
            else if(courseCode[i].value === "chm104"){
                courseUnit = 1
                grade[i].style.display ="block"
            }
            else if(courseCode[i].value === "mth102"){
                courseUnit = 1
                grade[i].style.display ="block"
            }
            else if(courseCode[i].value === "mth104"){
                courseUnit = 5
                grade[i].style.display ="block"
            }
            else if(courseCode[i].value === "phy102"){
                courseUnit = 4
                grade[i].style.display ="block"
            }
            else if(courseCode[i].value === "phy108"){
                courseUnit = 1
                grade[i].style.display ="block"
            }
